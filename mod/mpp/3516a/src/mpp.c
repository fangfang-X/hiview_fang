...
static SAMPLE_MPP_SENSOR_T libsns[SAMPLE_SNS_TYPE_BUTT] = {
    ...
    {SONY_IMX378_MIPI_8M_30FPS_10BIT,                 "imx378-0-0-8-30", "libsns_imx378.so", "stSnsImx378Obj"},
    ...
    {SONY_IMX585_MIPI_8M_30FPS_12BIT,           "imx585-0-0-8-30", "libsns_imx585.so", "stSnsImx585Obj"},
