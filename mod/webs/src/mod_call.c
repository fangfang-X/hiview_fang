...
//codec;
  ...
  {GSF_ID_CODEC_IMGSCENE, "GSF_ID_CODEC_IMGSCENE", GSF_IPC_CODEC,(sjb_cb*)sjb_bind_gsf_img_scene_t,   (sjb_cb*)sjb_bind_gsf_img_scene_t,sizeof(gsf_img_scene_t), sizeof(gsf_img_scene_t),0},
  {GSF_ID_CODEC_IMGSHARPEN, "GSF_ID_CODEC_IMGSHARPEN", GSF_IPC_CODEC,(sjb_cb*)sjb_bind_gsf_img_sharpen_t,   (sjb_cb*)sjb_bind_gsf_img_sharpen_t,sizeof(gsf_img_sharpen_t), sizeof(gsf_img_sharpen_t),0},
  {GSF_ID_CODEC_IMGHLC, "GSF_ID_CODEC_IMGHLC", GSF_IPC_CODEC,(sjb_cb*)sjb_bind_gsf_img_hlc_t,   (sjb_cb*)sjb_bind_gsf_img_hlc_t,sizeof(gsf_img_hlc_t), sizeof(gsf_img_hlc_t),0},
  {GSF_ID_CODEC_IMGGAMMA, "GSF_ID_CODEC_IMGGAMMA", GSF_IPC_CODEC,(sjb_cb*)sjb_bind_gsf_img_gamma_t,   (sjb_cb*)sjb_bind_gsf_img_gamma_t,sizeof(gsf_img_gamma_t), sizeof(gsf_img_gamma_t),0},
